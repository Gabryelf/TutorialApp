...
## 📚 Содержание
1. [DDL — создание структуры](#ddl--создание-структуры)
2. [DML — манипуляция данными](#dml--манипуляция-данными)
3. [DQL — выборка данных](#dql--выборка-данных)
4. [DCL — управление доступом](#dcl--управление-доступом)
5. [TCL — транзакции](#tcl--транзакции)
6. [Служебные команды](#служебные-команды)
7. [Полезные функции](#полезные-функции)
8. [Шпаргалка по JOIN](#шпаргалка-по-join)

---

## 🏗️ DDL — создание структуры {#ddl--создание-структуры}
...
## ✏️ DML — манипуляция данными {#dml--манипуляция-данными}
...
## 🔍 DQL — выборка данных {#dql--выборка-данных}
...
## 🔐 DCL — управление доступом {#dcl--управление-доступом}
...
## 🛠️ Служебные команды {#служебные-команды}
*Служебные команды*
...
## 🔗 Шпаргалка по JOIN {#шпаргалка-по-join}
